...
class Menu {
    ...
    public function render($params){
        ...
        $render = '<nav class="'.$this->divClass.'"><ul class="'.$this->ulClass.'" id="'.$this->ulId.'">';
    ...
    public function renderItem($item){
        ...
        return '<a href="'.url($item['url']).'" class="'.$item['aclass'].'" '.$isActive.' > <i class="'.$this->icon.'"></i> '.$item['label'].'</a>';
    }
